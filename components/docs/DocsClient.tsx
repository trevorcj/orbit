...
function CodeSnippet({
  ...
  return (
    <div className="relative my-3 rounded-xl border border-zinc-200 bg-[#0A0F19] text-zinc-100 overflow-hidden font-mono text-xs shadow-xs">
      {title && (
      ...
      <div className="p-4 overflow-x-auto">
        <pre className="text-emerald-400 leading-relaxed">{code}</pre>
      </div>
      <button
        onClick={copy}
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 antialiased">
          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="flex items-center gap-2">
              <Image
                ...
                width={85}
                height={20}
                className="w-auto h-5 block"
                priority
              />
            </Link>
            <span className="text-xs px-2 py-0.5 rounded-full font-mono bg-zinc-100 text-zinc-600 font-medium border border-zinc-200">
              v1.0 Docs
            </span>
          </div>
      ...
      <div className="max-w-7xl mx-auto flex px-4 sm:px-6">
        {/* ================= LEFT SIDEBAR ================= */}
        <aside className="hidden lg:block w-64 shrink-0 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto py-8 pr-6 border-r border-zinc-200">
            ...
            {navSections.map((section) => {
              ...
              return (
                <div key={section.title}>
                  <h4 className="font-bold text-zinc-900 uppercase tracking-wider text-[11px] mb-2 px-2">
                    {section.title}
                  </h4>
                        ...
                        <li key={item.id}>
                          <button
                            ...
                            className={`w-full text-left px-2.5 py-1.5 rounded-md font-medium transition-colors flex items-center justify-between cursor-pointer ${
                              isActive
                                ? "bg-zinc-100  text-[#0F86EE]  font-semibold"
                                : "text-zinc-600  hover:text-zinc-900  hover:bg-zinc-50 "
                            }`}>
                            <span>{item.label}</span>
                            {item.badge && (
                              <span className="text-[10px] px-1.5 py-0.2 rounded bg-[#0F86EE]/10 text-[#0F86EE] font-bold">
                                {item.badge}
                              </span>
                            )}
                          </button>
        ...
        <main className="flex-1 min-w-0 py-8 lg:px-10 max-w-4xl">
          ...
          <section id="welcome" className="scroll-mt-24 mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-200 bg-blue-50 text-xs font-semibold text-blue-700 mb-4">
              <Sparkles size={14} />
          ...
          {/* ================= MENTAL MODEL ================= */}
          <section id="mental-model" className="scroll-mt-24 mb-12 pt-8 border-t border-zinc-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4 text-xs">
              <div className="p-4 rounded-xl border border-zinc-200 bg-white">
                <div className="font-bold text-zinc-900 mb-1">1. Customer Subscribes</div>
                <p className="text-zinc-500">Customer pays ₦10,000 via Orbit hosted checkout. Orbit saves their card token securely with Paystack.</p>
              </div>
              <div className="p-4 rounded-xl border border-zinc-200 bg-white">
                <div className="font-bold text-zinc-900 mb-1">2. Orbit Manages Renewals</div>
                <p className="text-zinc-500">Every 30 days, Orbit automatically charges their card token in the background and splits payments.</p>
              </div>
              <div className="p-4 rounded-xl border border-zinc-200 bg-white">
                <div className="font-bold text-zinc-900 mb-1">3. Your App Verifies</div>
                <p className="text-zinc-500">Your app simply asks Orbit: <em>&quot;Is this customer active?&quot;</em> or listens to real-time Webhooks.</p>
              </div>
            </div>
          </section>

          {/* ================= MERCHANT & PAYOUTS GUIDE ================= */}
          <section id="payouts-overview" className="scroll-mt-24 mb-12 pt-8 border-t border-zinc-200">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight text-zinc-900 mb-3">
            ...
            {/* SPLIT BREAKDOWN BOX */}
            <div id="platform-fee" className="scroll-mt-24 mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono">
                <div className="p-3.5 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-800">
                ...
                <div className="p-3.5 rounded-lg bg-zinc-50 border border-zinc-200 text-zinc-800">
            ...
            <div id="split-payments" className="scroll-mt-24 mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
              <h3 className="text-base font-bold text-zinc-900 mb-2 flex items-center gap-2">
            ...
            {/* LINKING BANK */}
            <div id="merchant-bank-setup" className="scroll-mt-24 p-5 rounded-xl border border-zinc-200 bg-zinc-50/50">
          ...
          {/* ================= API KEYS & AUTH ================= */}
          <section id="api-keys" className="scroll-mt-24 mb-12 pt-8 border-t border-zinc-200">
            <h2 className="text-2xl font-bold tracking-tight text-zinc-900 mb-3">
              API Keys &amp; Authentication
            </h2>
            <p className="text-sm text-zinc-600 leading-relaxed mb-4">
              Authenticate requests by sending your key in the <code className="font-mono bg-zinc-100 px-1 py-0.5 rounded">Authorization</code> header:
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 text-xs">
              <div className="p-4 rounded-xl border border-emerald-200 bg-emerald-50/40">
                <div className="font-mono font-bold text-emerald-700 mb-1">
              ...
              <div className="p-4 rounded-xl border border-rose-200 bg-rose-50/40">
                <div className="font-mono font-bold text-rose-700 mb-1">
                  sk_live_... (Secret)
                </div>
                <p className="text-zinc-600">
          ...
          {/* ================= 5-MINUTE QUICKSTART ================= */}
          <section id="quickstart" className="scroll-mt-24 mb-12 pt-8 border-t border-zinc-200">
            <h2 className="text-2xl font-bold tracking-tight text-zinc-900 mb-3">
...
export async function GET(req: Request) {
  ...
  return NextResponse.json({ accessGranted: false, reason: "No active subscription" });
          ...
          {/* ================= POSTMAN TESTING ================= */}
          <section id="postman-testing" className="scroll-mt-24 mb-12 pt-8 border-t border-zinc-200">
            <h2 className="text-2xl font-bold tracking-tight text-zinc-900 mb-3">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-xs text-zinc-600 mb-4">
              <li>Open Postman and create a new <code className="font-mono font-semibold">GET</code> request.</li>
              <li>Enter URL: <code className="font-mono bg-zinc-100 px-1 py-0.5 rounded">{appUrl}/api/v1/customers/idawari005@gmail.com/subscription</code></li>
          ...
          {/* ENDPOINT: GET /api/v1 */}
          <div id="api-root" className="scroll-mt-24 mb-10 p-6 rounded-xl border border-zinc-200 bg-white">
  ...
  -H "Authorization: Bearer sk_live_YOUR_KEY"`}
          ...
          <div id="check-subscription" className="scroll-mt-24 mb-10 p-6 rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center gap-3 mb-2">
              <MethodBadge method="GET" />
              <code className="text-sm font-mono font-bold text-zinc-900">
  ...
  -H "Authorization: Bearer sk_live_YOUR_KEY"`}
            ...
            <p className="text-xs font-semibold text-zinc-700 mt-3 mb-1">Response (200 OK):</p>
            <CodeSnippet
              title="Response"
              language="json"
              code={`{
  ...
  "plan": {
    ...
    "features": ["All core features", "Email support"]
            ...
            <div className="mt-3 p-3 rounded-lg bg-zinc-50 border border-zinc-200 text-xs">
              <span className="font-semibold text-zinc-800 block mb-1">Possible <code>status</code> values:</span>
              <ul className="space-y-1 text-zinc-600 pl-4 list-disc">
          ...
          <div id="checkout-sessions" className="scroll-mt-24 mb-10 p-6 rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center gap-3 mb-2">
  ...
  -d '{
    ...
    "success_url": "https://yourapp.com/dashboard?subscribed=true"
          ...
          <div id="list-products" className="scroll-mt-24 mb-10 p-6 rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center gap-3 mb-2">
              <MethodBadge method="GET" />
              <code className="text-sm font-mono font-bold text-zinc-900">
                /api/v1/products
  ...
  -H "Authorization: Bearer pk_live_YOUR_PUBLISHABLE_KEY"`}
          ...
          <div id="get-product" className="scroll-mt-24 mb-10 p-6 rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center gap-3 mb-2">
              <MethodBadge method="GET" />
              <code className="text-sm font-mono font-bold text-zinc-900">
  ...
  -H "Authorization: Bearer pk_live_YOUR_PUBLISHABLE_KEY"`}
          ...
          <div id="list-plans" className="scroll-mt-24 mb-10 p-6 rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center gap-3 mb-2">
              <MethodBadge method="GET" />
              <code className="text-sm font-mono font-bold text-zinc-900">
                /api/v1/plans
  ...
  -H "Authorization: Bearer pk_live_YOUR_KEY"`}
          ...
          <div id="cancel-subscription" className="scroll-mt-24 mb-10 p-6 rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center gap-3 mb-2">
              <MethodBadge method="POST" />
              <code className="text-sm font-mono font-bold text-zinc-900">
  ...
  -d '{ "cancel_at_period_end": true }'`}
          ...
          {/* ================= WEBHOOKS DEEP DIVE ================= */}
          <section id="webhooks-why" className="scroll-mt-24 mb-12 pt-8 border-t border-zinc-200">
            <h2 className="text-3xl font-extrabold tracking-tight text-zinc-900 mb-3">
              Webhooks (Deep Dive)
            </h2>
            <p className="text-sm text-zinc-600 leading-relaxed mb-4">
            ...
            <div id="signature-explained" className="scroll-mt-24 p-5 rounded-xl border border-zinc-200 bg-zinc-50 my-4">
              ...
              <code className="block p-3 rounded-lg bg-zinc-100 text-xs font-mono text-zinc-800 break-all select-all">
                t=1756184000,v1=a849f7b1c3d2e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9
              </code>
            </div>

            {/* FULL WEBHOOK CODE */}
            <h3 id="webhook-code" className="text-xl font-bold text-zinc-900 mt-8 mb-2">
              Complete, Copy-Pasteable Webhook Handler (Next.js App Router)
            </h3>
            <p className="text-xs text-zinc-500 mb-2">
              Create this file at <code className="font-mono bg-zinc-100 px-1 py-0.5 rounded">app/api/webhooks/orbit/route.ts</code> in your project:
            </p>
...
export async function POST(req: NextRequest) {
  ...
  return NextResponse.json({ received: true });
            ...
            <div id="webhook-events" className="scroll-mt-24 mt-10 pt-6 border-t border-zinc-200">
              ...
              <div className="mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-0.5 rounded font-mono text-[11px] font-bold bg-emerald-100 text-emerald-700 border border-emerald-200">
                    payment.succeeded
                  </span>
                  <span className="text-xs text-zinc-500">Triggered whenever any payment successfully processes.</span>
                </div>
                <CodeSnippet
  ...
  "data": {
    ...
    "reference": "orbit_ord_9f83a8b27c10"
              ...
              <div className="mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-0.5 rounded font-mono text-[11px] font-bold bg-rose-100 text-rose-700 border border-rose-200">
                    payment.failed
                  </span>
                  <span className="text-xs text-zinc-500">Triggered when a recurring billing attempt is declined (e.g. insufficient funds).</span>
                </div>
                <CodeSnippet
  ...
  "data": {
    ...
    "next_retry_at": "2026-08-22T06:30:00.000Z"
              ...
              <div className="mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-0.5 rounded font-mono text-[11px] font-bold bg-blue-100 text-blue-700 border border-blue-200">
                    subscription.created
                  </span>
                  <span className="text-xs text-zinc-500">Triggered when a customer completes their first checkout.</span>
                </div>
                <CodeSnippet
  ...
  "data": {
    ...
    "renews_at": "2026-09-21T06:30:00.000Z"
              ...
              <div className="mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-0.5 rounded font-mono text-[11px] font-bold bg-purple-100 text-purple-700 border border-purple-200">
                    subscription.renewed
                  </span>
                  <span className="text-xs text-zinc-500">Triggered upon successful automatic recurring billing renewal.</span>
                </div>
                <CodeSnippet
  ...
  "data": {
    ...
    "renews_at": "2026-10-21T06:30:00.000Z"
              ...
              <div className="mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-0.5 rounded font-mono text-[11px] font-bold bg-amber-100 text-amber-700 border border-amber-200">
                    subscription.cancelled
                  </span>
                  <span className="text-xs text-zinc-500">Triggered when a customer or admin cancels a subscription.</span>
                </div>
                <CodeSnippet
  ...
  "data": {
    ...
    "ends_at": "2026-09-21T06:30:00.000Z"
              ...
              <div className="p-5 rounded-xl border border-zinc-200 bg-white">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-0.5 rounded font-mono text-[11px] font-bold bg-zinc-100 text-zinc-700 border border-zinc-200">
                    subscription.updated
                  </span>
                  <span className="text-xs text-zinc-500">Triggered when a plan or billing tier is upgraded or modified.</span>
                </div>
                <CodeSnippet
  ...
  "data": {
    ...
    "new_plan_name": "Annual Pro"
          ...
          <section id="hosted-checkout" className="scroll-mt-24 mb-12 pt-8 border-t border-zinc-200">
            <h2 className="text-3xl font-extrabold tracking-tight text-zinc-900 mb-3">
            ...
            <div className="mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
              ...
              <p className="text-xs text-zinc-600 mb-3 leading-relaxed">
                When you create a Product in the Orbit Dashboard (e.g. &quot;Bolder SaaS&quot; with slug <code className="font-mono text-zinc-800">bolder-saas</code>), Orbit automatically hosts a checkout page for it.
                <br /><br />
                Just link your website&apos;s &quot;Subscribe&quot; buttons directly to:
              </p>
              <code className="block p-3 rounded-lg bg-zinc-100 text-xs font-mono text-[#0F86EE] select-all">
                {`${appUrl}/checkout/YOUR_PRODUCT_SLUG`}
              </code>
            </div>

            {/* OPTION 2 */}
            <div id="custom-checkout" className="mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
              <div className="flex items-center gap-2 text-sm font-bold text-zinc-900 mb-2">
            ...
            {/* OPTION 3 */}
            <div id="react-component" className="mb-6 p-5 rounded-xl border border-zinc-200 bg-white">
              <div className="flex items-center gap-2 text-sm font-bold text-zinc-900 mb-2">
                <Code2 size={16} className="text-emerald-500" />
                <span>Method 3: React Pricing Component (shadcn-style Copy &amp; Paste)</span>
              </div>
              <p className="text-xs text-zinc-600 mb-3 leading-relaxed">
                If you want a pre-built React pricing grid that automatically fetches your product&apos;s plans, you can copy the following file into your project at <code className="font-mono bg-zinc-100 px-1 py-0.5 rounded">components/OrbitPricingTable.tsx</code>:
              </p>
...
export default function OrbitPricingTable({
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
      {product?.plans?.map((plan: any) => (
        <div key={plan.id} className="p-6 rounded-2xl border bg-white shadow-xs">
          ...
          {/* ================= ERRORS & STATUS CODES ================= */}
          <section id="error-handling" className="scroll-mt-24 mb-12 pt-8 border-t border-zinc-200">
            <h2 className="text-3xl font-extrabold tracking-tight text-zinc-900 mb-3">
              Errors &amp; Status Codes
            </h2>
            <p className="text-sm text-zinc-600 leading-relaxed mb-4">
  ...
  "error": {
    ...
    "message": "Invalid API key provided. Check your Authorization header."
            ...
            <div id="status-codes" className="overflow-x-auto rounded-xl border border-zinc-200 my-6">
              <table className="w-full text-left text-xs border-collapse">
                ...
                <tbody className="divide-y divide-zinc-100 bg-white">
                  <tr>
                    ...
                    <td className="py-3 px-4 text-zinc-600">The request succeeded.</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-mono font-bold text-amber-600">400 Bad Request</td>
                    <td className="py-3 px-4">Missing Parameters</td>
                    <td className="py-3 px-4 text-zinc-600">Check required JSON body fields.</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-mono font-bold text-rose-600">401 Unauthorized</td>
                    <td className="py-3 px-4">Invalid API Key</td>
                    <td className="py-3 px-4 text-zinc-600">Ensure header is <code className="font-mono">Authorization: Bearer sk_live_...</code>.</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-mono font-bold text-rose-600">404 Not Found</td>
                    <td className="py-3 px-4">Resource not found</td>
                    <td className="py-3 px-4 text-zinc-600">The requested customer, plan, or product does not exist in your organization.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <aside className="hidden xl:block w-52 shrink-0 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto py-8 pl-4">
          <p className="text-xs font-bold uppercase tracking-wider text-zinc-900 mb-3">
            On this page
          </p>
          <div className="flex flex-col text-xs space-y-2 border-l border-zinc-200">
            {[
              { id: "welcome", label: "Welcome to Orbit" },
              ...
              return (
                <button
                  ...
                  className={`text-left pl-3 py-0.5 transition-colors cursor-pointer border-l -ml-[1px] ${
                    isActive
                      ? "border-[#0F86EE] font-semibold text-[#0F86EE] "
